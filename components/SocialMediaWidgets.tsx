    ...
    return (
      <div  className={'flex xl:flex-col justify-center'}>
          <div id={'github_profile_div'}>
              <a href='https://github.com/Ntrigued' className={'flex justify-center items-center ' +
                  'xl:my-[5%]'}>
                  <Image src={githubLogo} alt={'github logo, link to profile'}
                         className={'max-w-[25%]'} width={114} />
              </a>
          </div>
          <div id={'twitter_follow_div'} className={'flex min-h-[28px] min-w-[114px] items-center ' +
              'xl:flex-col xl:my-[5%]'}>
